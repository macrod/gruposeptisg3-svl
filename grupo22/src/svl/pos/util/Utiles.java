...
public class Utiles 
{
  ...
  *******************************************************************************/
  ...
  /*******************************************************************************
  ** Método que obtiene la pagina destino de una aplicacion
  ** @param nombrePro Valor con el nombre del dialogo base
  ** @return String Pagina destino
  *******************************************************************************/
  public static String obtenerDestino(String nombrePro)
  {
    String destino = "";

    if(nombrePro != null && nombrePro.equals("admconsusua"))
    {
      destino = "/ServletAdmninistracion?accion=admconsusua";
    }
    else if(nombrePro != null && nombrePro.equals("admdelusua"))
    {
      destino = "/ServletAdmninistracion?accion=admdelusua";
    }
    else if(nombrePro != null && nombrePro.equals("admaddusua"))
    {
      destino = "/ServletAdmninistracion?accion=admaddusua";
    } 
    else if(nombrePro != null && nombrePro.equals("admmodusua"))
    {
      destino = "/ServletAdmninistracion?accion=admmodusua";
    }
    else if(nombrePro != null && nombrePro.equals("salir"))
    {
      destino = "Inicio.htm";
    }
