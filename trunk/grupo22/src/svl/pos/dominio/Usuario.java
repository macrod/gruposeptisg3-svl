...
public class Usuario {
	...
	private Date usua_falta;
	private Date usua_fbaja;
	private boolean usua_esvoluntario;
	private boolean usua_esdemandante;
	private boolean usua_esadmin;
	
	//private IUsuarioDAO udao = new JDBCUsuarioDAO();
	
	
	public Usuario(String usua_id, String usua_usuario, String usua_clave, String usua_nombre,
			...
			Date usua_falta, Date usua_fbaja,boolean usua_esvoluntario, boolean usua_esdemandante, boolean usua_esadmin) {
		super();
	...
	public Date getUsua_falta() {
		return usua_falta;
	}
	public void setUsua_falta(Date usua_falta) {
		this.usua_falta = usua_falta;
	}
	
	public Date getUsua_fbaja() {
		return usua_fbaja;
	}
	public void setUsua_fbaja(Date usua_fbaja) {
		this.usua_fbaja = usua_fbaja;
	}
	
	public boolean getUsua_esvoluntario() {
		return usua_esvoluntario;
	}
	public void setUsua_esvoluntario(boolean usua_esvoluntario) {
		this.usua_esvoluntario = usua_esvoluntario;
	}
	
	public boolean getUsua_esdemandante() {
		return usua_esdemandante;
	}
	public void setUsua_esdemandante(boolean usua_esdemandante) {
		this.usua_esdemandante = usua_esdemandante;
	}
	
	public boolean getUsua_esadmin() {
		return usua_esadmin;
	}
	public void setUsua_esadmin(boolean usua_esadmin) {
		this.usua_esadmin = usua_esadmin;
	}
